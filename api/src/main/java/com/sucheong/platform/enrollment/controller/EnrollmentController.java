...
public class EnrollmentController {
    ...
    ResponseEntity<String> enroll(@RequestBody EnrollmentRequest request) {
        ...
        if(!enrollmentHistoryUsecase.isFirstRequestFromUser(request.getLectureId(), request.getUserId())) {
        ...
        requestEnrollmentUsecase.queue(request.getLectureId(), request.getUserId());
